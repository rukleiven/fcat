from fcat import (
    ...
    AsymetricIcedSkywalkerX8Properties
)

__all__ = ('aircraft_property_from_dct', 'actuator_from_dct')

# Global constants
SKYWALKERX8_ASYMETRIC = 'skywalkerX8_asymetric'
...
def aircraft_property_from_dct(aircraft: dict) -> AircraftProperties:
    ...
    """
    known_types = [SKYWALKERX8, FRICTIONLESS_BALL, AIRCRAFT_NO_FORCE, SKYWALKERX8_ASYMETRIC]
    ...
    if aircraft_type == SKYWALKERX8:
        ...
        return AsymetricIcedSkywalkerX8Properties(ControlInput(), aircraft.get('icing_left_wing', 0),
